 ...
 * @author KevinNS
 */
public class TeoriaT10ArrayList {

    public static void main(String[] args) {

        // 0. CLASES ENVOLTORIO (WRAPPER): envuelven un tipo de dato simple en un objeto
//         int edad = 20;
//         Integer edadInteger = edad; // Autoboxing
//         int edad2 = edadInteger; // AutoUnBoxing
//         
//         System.out.println(edadInteger);
//         System.out.println(edadInteger.getClass());
//         
//         String edadString = String.valueOf(edad);
//         System.out.println(edadString);
//         System.out.println(edadString.getClass());
//         
//         String pass = "1234";
//         System.out.println(pass + 5);
//         int passInt = Integer.parseInt(pass);
//         System.out.println(passInt + 5);
//         
//         String edadString2 = Integer.toString(edad);
//         System.out.println(edadString2);
//         System.out.println(edadString2.getClass());

        // 1. ArrayList
        // 1.1 Crear un ArrayList
