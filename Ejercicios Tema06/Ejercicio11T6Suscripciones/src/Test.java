...
/**
 * Añade una clase principal donde crees un objeto de cada tipo de
 * suscripción. Después, crea un menú en el que muestres los
 * datos de las dos suscripciones y pregunta al usuario qué
 * suscripción quiere seleccionar. Finalmente, procesa el pago.
 *
 * @author KevinNS
 */
public class Test {
