...
public class Servidor extends Ordenador {
    ...
    public Servidor(int memoriaRam, int discoDuro, String modeloProcesador, String modeloGrafica,
            double precio, int tamañoMonitor, String modeloTeclado, String modeloRaton) {
